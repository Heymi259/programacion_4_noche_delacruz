...
fun S04_LayoutScreen_mp() {
    Column(
        ...
        // ── COLUMN ─────────────────────────────────────────────────────────
        EtiquetaSeccion_mp("Column — apila verticalmente")
        Column(
            modifier            = Modifier
                .fillMaxWidth()
        ...
        // ── ROW con Arrangement ────────────────────────────────────────────
        EtiquetaSeccion_mp("Row — SpaceBetween")
        Row(
            modifier              = Modifier
                .fillMaxWidth()
        ...
        EtiquetaSeccion_mp("Row — SpaceEvenly")
        Row(
            modifier              = Modifier
                .fillMaxWidth()
        ...
        // ── ROW con weight ─────────────────────────────────────────────────
        EtiquetaSeccion_mp("Row + weight (distribución proporcional 1:2:1)")
        ...
        // ── BOX ────────────────────────────────────────────────────────────
        EtiquetaSeccion_mp("Box — superpone capas con align por capa")
        Box(
            modifier         = Modifier
                .fillMaxWidth()
                .height(120.dp)
...
@Composable
fun S04_Preview_mp() {
    MaterialTheme { S04_LayoutScreen_mp() }
}
