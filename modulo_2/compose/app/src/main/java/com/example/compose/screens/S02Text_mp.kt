...
fun S02TextScreen_mp() {
    Column(
        ...
        EtiquetaSeccion_mp("1. Texto básico")
        Text("Texto simple sin propiedades adicionales")

        EtiquetaSeccion_mp("2. fontSize + fontWeight + fontStyle")
        ...
        EtiquetaSeccion_mp("3. Color y decoración")
        Text("Texto en azul",
        ...
        EtiquetaSeccion_mp("4. maxLines + TextOverflow")
        Text(
        ...
        EtiquetaSeccion_mp("5. Escala tipográfica Material 3")
        ...
        EtiquetaSeccion_mp("6. TextAlign")
        Text(
...
@Composable
internal fun EtiquetaSeccion_mp(texto: String) {
    Text(
        text  = texto,
