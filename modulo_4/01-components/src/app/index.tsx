...
function Paso2() {
  return (
    <View style={styles.fondo}>
      <Text style={styles.encabezado}>Detalle de nodo</Text>

      <Card titulo="web-01" subtitulo="Servidor web principal" color="#1565c0">
      ...
      <Card titulo="Conexiones activas" color="#2e7d32">
      ...
      <Card titulo="Disco" color="#e65100">
        <FilaInfo etiqueta="Usado" valor="42 GB (53%)" />
        <FilaInfo etiqueta="Libre" valor="38 GB" />
        <FilaInfo etiqueta="Inodo" valor="98% disponible" />
      </Card>

      <Text style={styles.encabezado}>Métricas fuera de Card</Text>
      <FilaInfo etiqueta="CPU" valor="4 vCPU · 48%" />
      <FilaInfo etiqueta="RAM" valor="8 GB · 3.1 GB usados" />
    </View>
  )
