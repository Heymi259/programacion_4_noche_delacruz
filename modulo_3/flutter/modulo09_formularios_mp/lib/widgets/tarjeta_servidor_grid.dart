          ...
          children: [
            ...
            Row(children: [
              Icon(
                ...
                color: servidor.completado ? cs.primary : cs.outline,
                size: 18,
              ),
              const Spacer(),
              GestureDetector(
            ...
            Text(
              '${servidor.peso} kg · ${servidor.series}x${servidor.repeticiones}',
              style: text.bodySmall?.copyWith(color: cs.onSurfaceVariant),
            ),

            const Spacer(),

            // Fila inferior: completado + grupo + eliminar
            Row(children: [
              if (servidor.completado)
                Padding(
