        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: KpiCard(
                  ...
                  subtitle: data.outOfStockProducts > 0
                      ? '${data.outOfStockProducts} sin equipo' : null,
              ...
              Expanded(
                child: KpiCard(
                  title:    'Grupos musculares activos',
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                  isOut ? 'Sin equipo' : '${p.stock} equipos',
                                  style: TextStyle(
          ...
          _SectionCard(
            ...
            child: Wrap(
              ...
              children: [
                ('+ Grupo muscular', AppColors.info,    '/admin/categories'),
                ('+ Ejercicio',  AppColors.accent,  '/admin/products'),
                ('Ver sesiones', AppColors.success,  '/admin/orders'),
                ('Miembros',    AppColors.warning,  '/admin/users'),
