            ...
            children: [
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${state.categories.length} grupos musculares',
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                    hintText:   'Buscar grupo muscular...',
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text(
                      state.search.isEmpty ? 'Sin grupos musculares' : 'Sin resultados',
  ...
  void _confirmDelete(BuildContext context, WidgetRef ref, Category cat) {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Text(
          hasProducts ? '¿Desactivar grupo muscular?' : '¿Eliminar grupo muscular?',
          style: const TextStyle(color: AppColors.textPrimary),
        ),
        content: Text(
          hasProducts
              ? '"${cat.name}" tiene ${cat.totalProducts} ejercicio(s). Se desactivará en lugar de eliminarse.'
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${category.totalProducts} ejercicio${category.totalProducts != 1 ? "s" : ""}',
                  style: const TextStyle(
