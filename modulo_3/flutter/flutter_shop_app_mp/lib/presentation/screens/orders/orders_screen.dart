...
import 'package:flutter_shop_app/presentation/providers/order_provider.dart';
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Mis sesiones', style: tt.headlineMedium),
                          Text(
                            '${state.total} sesión${state.total != 1 ? "es" : ""}',
                            style: tt.bodySmall,
                          ),
                        ],
                      ),
                  ...
                  return const Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Tus sesiones aparecerán aquí',
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Sesión #${order.id}', style: tt.titleMedium),
            ...
            Row(
              ...
              children: [
                Text(
                  '${order.numItems} ejercicio${order.numItems != 1 ? "s" : ""}',
                  style: tt.bodySmall,
                ),
                Row(
                  children: [
