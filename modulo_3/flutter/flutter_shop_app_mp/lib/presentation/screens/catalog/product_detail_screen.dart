  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (product.id == 0) {
      return Scaffold(
        appBar: AppBar(),
        body: const Center(
          child: Text('Exercise not found', style: TextStyle(color: AppColors.error)),
        ),
      );
    }
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  // Category
                  Text(
                    (p.category?.name ?? 'Sin grupo muscular').toUpperCase(),
                  ...
                  ElevatedButton(
                    ...
                    onPressed: outOfStock
                        ...
                        : () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  '✅ $_quantity× ${p.name} agregado a la rutina',
                                ),
                    ...
                    child: Text(
                      outOfStock
                          ? 'Sin equipo'
                          : 'Añadir${_quantity > 1 ? ' $_quantity×' : ''} a rutina',
                    ),
                  ),
