...
extension ProductStockFilterLabel on ProductStockFilter {
  String get label => switch (this) {
    ...
    ProductStockFilter.inStock    => 'Con equipo',
    ProductStockFilter.outOfStock => 'Sin equipo',
  ...
  Future<void> createProduct(Map<String, dynamic> payload) async {
    ...
    try {
      ...
      state = state.copyWith(
        ...
        total:     state.total + 1,
        formState: const ProductFormSuccess('Ejercicio creado'),
      );
    } catch (e) {
      state = state.copyWith(
  ...
  Future<void> updateProduct(int id, Map<String, dynamic> payload) async {
    ...
    try {
      ...
      state = state.copyWith(
        ...
        formState: const ProductFormSuccess('Ejercicio actualizado'),
      );
    } catch (e) {
      state = state.copyWith(
        formState: ProductFormError(
