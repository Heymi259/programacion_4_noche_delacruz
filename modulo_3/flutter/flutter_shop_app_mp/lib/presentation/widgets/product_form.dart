      ...
      child:   SingleChildScrollView(
        ...
        child:   Column(
          ...
          children: [
            ...
            Text(
              isEdit ? 'Editar: ${widget.initial!.name}' : 'Nuevo ejercicio',
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          style:       const TextStyle(color: AppColors.textPrimary),
                          validator:   (v) => validatePositiveNumber(v, 'Peso'),
                        ),
                      ),
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration:  const InputDecoration(labelText: 'Equipos *'),
                          style:       const TextStyle(color: AppColors.textPrimary),
                  ...
                  DropdownButtonFormField<int>(
                    ...
                    validator: (v) => v == null ? 'Selecciona un grupo muscular' : null,
                  ),
                  const SizedBox(height: 12),
