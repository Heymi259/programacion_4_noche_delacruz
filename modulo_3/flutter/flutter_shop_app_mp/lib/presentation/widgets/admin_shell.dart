...
const adminNavItems = [
  ...
  AdminNavItem(label: 'Grupos musculares', icon: Icons.category_outlined,        route: '/admin/categories'),
  AdminNavItem(label: 'Ejercicios',  icon: Icons.inventory_2_outlined,     route: '/admin/products'),
  AdminNavItem(label: 'Sesiones',    icon: Icons.shopping_bag_outlined,    route: '/admin/orders'),
  AdminNavItem(label: 'Miembros',   icon: Icons.people_outline,           route: '/admin/users'),
];
