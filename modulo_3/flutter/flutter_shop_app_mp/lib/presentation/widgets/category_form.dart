      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              isEdit ? 'Editar: ${widget.initial!.name}' : 'Nuevo grupo muscular',
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text('Grupo muscular activo',
                                style: TextStyle(
                                  color:      AppColors.textPrimary,
                                  fontWeight: FontWeight.w600,
                                )),
                            const Text('Visible en la app',
                                style: TextStyle(
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          child:     isSaving
                              ...
                              : Text(isEdit ? 'Guardar cambios' : 'Crear grupo muscular'),
                        ),
                      ),
                    ],
                  ),
